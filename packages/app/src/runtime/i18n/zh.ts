...
export const dict = {
  ...
  "myTodo.promptProjectRequired": "请先在左上角选择一个 PLM 项目，再继续发送提示词。",
  ...
  "session.location.description": "请另外选择一个目录以继续此会话。",
  "session.location.choose": "选择目录",
  "session.location.worktree": "选择工作区",
  "session.location.worktreesFailed": "加载工作区失败",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 SigmaAgents 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 SigmaAgents 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 SigmaAgents 中使用 {{provider}} 模型。",
  ...
  "dialog.userLogin.title": "天华 SSO 登录",
  "dialog.userLogin.description": "请输入您的天华用户名和密码。",
  "dialog.userLogin.success": "登录成功。请重新启动 SigmaAgents。",
  "dialog.userLogin.username": "用户名",
  "dialog.userLogin.usernamePlaceholder": "请输入用户名",
  "dialog.userLogin.password": "密码",
  "dialog.userLogin.passwordPlaceholder": "请输入密码",
  "dialog.userLogin.exit": "退出 SigmaAgents",
  "dialog.userLogin.submit": "登录",
  "dialog.userLogin.submitting": "登录中…",
  ...
  "error.page.report.prefix": "请将此错误报告给 SigmaAgents 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：SigmaAgents 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "使用您的天华账号和密码登录。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 SigmaAgents 服务器。",
  ...
  "settings.general.row.language.description": "更改 SigmaAgents 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 SigmaAgents 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 SigmaAgents 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 SigmaAgents 的主题。",
  ...
  "settings.updates.row.startup.description": "在 SigmaAgents 启动时自动检查更新",
