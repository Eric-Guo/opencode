...
const Endpoint30_0 = (raw: RawClient["server.config"]) => () =>
  preserveEffect<Endpoint30_0Output>()(raw["config.get"]({}).pipe(Effect.mapError(mapClientError)))
...
const adaptClient = (raw: RawClient) => ({
  ...
  "server.config": adaptGroup30(raw["server.config"]),
})
