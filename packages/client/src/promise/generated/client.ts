...
export function make(options: ClientOptions) {
  ...
  const request = async <A>(descriptor: RequestDescriptor, requestOptions?: RequestOptions): Promise<A> => {
    ...
    if (!descriptor.successStatuses.includes(response.status)) return responseError(response, descriptor)
  ...
  const sse = <A>(descriptor: RequestDescriptor, requestOptions?: RequestOptions): AsyncIterable<A> => ({
    async *[Symbol.asyncIterator]() {
      const response = await execute(descriptor, requestOptions)
      if (!descriptor.successStatuses.includes(response.status)) await responseError(response, descriptor)
    ...
    health: {
      get: (requestOptions?: RequestOptions) =>
        request<HealthGetOutput>(
          { method: "GET", path: `/api/health`, successStatuses: [200], declaredStatuses: [401, 400], empty: false },
          requestOptions,
        ),
    },
    server: {
      get: (requestOptions?: RequestOptions) =>
        request<ServerGetOutput>(
          { method: "GET", path: `/api/server`, successStatuses: [200], declaredStatuses: [401, 400], empty: false },
          requestOptions,
        ),
    },
    location: {
    ...
    project: {
      list: (requestOptions?: RequestOptions) =>
        request<ProjectListOutput>(
          { method: "GET", path: `/api/project`, successStatuses: [200], declaredStatuses: [401, 400], empty: false },
          requestOptions,
        ),
    ...
    event: {
      subscribe: (requestOptions?: RequestOptions): AsyncIterable<EventSubscribeOutput> =>
        sse<EventSubscribeOutput>(
          { method: "GET", path: `/api/event`, successStatuses: [200], declaredStatuses: [401, 400], empty: false },
          requestOptions,
        ),
    },
    pty: {
    ...
    config: {
      ...
      global: (requestOptions?: RequestOptions) =>
        request<ConfigGlobalOutput>(
          { method: "GET", path: `/global/config`, successStatuses: [200], declaredStatuses: [401, 400], empty: false },
          requestOptions,
        ),
    },
    audio: {
