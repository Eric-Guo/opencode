...
export const layer: Layer.Layer<Service, never, FSUtil.Service> = Layer.effect(
  Service,
  Effect.gen(function* () {
...
export const defaultLayer: Layer.Layer<Service> = layer.pipe(Layer.provide(FSUtil.defaultLayer))
