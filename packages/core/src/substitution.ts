...
export interface Interface {
  readonly substitute: (input: Input) => Effect.Effect<string, Error, never>
}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const substitute: Interface["substitute"] = Effect.fn("Substitution.substitute")(function* (input) {
