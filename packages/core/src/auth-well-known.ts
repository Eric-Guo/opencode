...
export interface Interface {
  readonly all: () => Effect.Effect<Record<string, Entry>, Error, never>
  readonly get: (url: string) => Effect.Effect<Entry | undefined, Error, never>
  readonly set: (url: string, entry: Entry) => Effect.Effect<void, Error, never>
  readonly remove: (url: string) => Effect.Effect<void, Error, never>
  readonly metadata: (url: string) => Effect.Effect<Metadata, Error, never>
  readonly configs: () => Effect.Effect<ConfigDocument[], Error, never>
}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const write = (operation: "migrate" | "write", data: Record<string, Entry>): Effect.Effect<void, Error> =>
