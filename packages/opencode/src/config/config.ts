...
const appFileSystemNode = LayerNode.make(AppFileSystem.defaultLayer, [])
...
export const node = LayerNode.make(layer, [appFileSystemNode, authWellKnownNode, substitutionNode, Account.node, Env.node, Npm.node, httpClient])
