...
import { app, BrowserWindow, Notification, clipboard, dialog, ipcMain, net, shell } from "electron"
...
import { signInToThapeSso, type SsoSignInCredentials } from "./thape-sso"
